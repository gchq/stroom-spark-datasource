 ...
 */
@Schema(description = "An object to describe how the query results should be returned, including which fields should be included and what sorting, grouping, filtering, limiting, etc. should be applied")
...
public class TableSettings {
  ...
  **/
   ...
   * @return showDetail
  **/
  @Schema(description = "When grouping is used a value of true indicates that the results will include the full detail of any results aggregated into a group as well as their aggregates. A value of false will only include the aggregated values for each group. Defaults to false.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.extractValues, tableSettings.extractValues) &&
        ...
        Objects.equals(this.queryId, tableSettings.queryId) &&
