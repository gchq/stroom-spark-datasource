...
public class ResultPageUser {
  ...
  public ResultPageUser pageResponse(PageResponse pageResponse) {
  ...
  **/
  ...
  public ResultPageUser values(List<User> values) {
    this.values = values;
    return this;
  }

  public ResultPageUser addValuesItem(User valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResultPageUser resultPageUser = (ResultPageUser) o;
    return Objects.equals(this.pageResponse, resultPageUser.pageResponse) &&
        Objects.equals(this.values, resultPageUser.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResultPageUser {\n");
