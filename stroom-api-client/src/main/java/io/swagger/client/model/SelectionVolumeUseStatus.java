...
public class SelectionVolumeUseStatus {
  ...
  public SelectionVolumeUseStatus matchAll(Boolean matchAll) {
  ...
  **/
  ...
  public SelectionVolumeUseStatus set(List<SetEnum> set) {
    this.set = set;
    return this;
  }

  public SelectionVolumeUseStatus addSetItem(SetEnum setItem) {
    if (this.set == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SelectionVolumeUseStatus selectionVolumeUseStatus = (SelectionVolumeUseStatus) o;
    return Objects.equals(this.matchAll, selectionVolumeUseStatus.matchAll) &&
        Objects.equals(this.set, selectionVolumeUseStatus.set);
  }
  ...
  public String toString() {
    ...
    sb.append("class SelectionVolumeUseStatus {\n");
